...
<body>
    <header>
        <div class="header-content">
            ...
            <img src="Pi7_Passport_Photo.jpeg" alt="Your Profile Picture" class="profile-picture">
            <h1>Sribala G</h1>
    ...
    <section id="resume">
        ...
        <div class="section-content">
            <center>
            <h2>Resume</h2>
            <a href="DOC-20250317-WA0010..pdf" target="_blank" class="download-button">Download CV</a>
        </center>
        </div>
